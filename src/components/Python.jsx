...
import python from "../assets/img/python-logo 1.svg";
import jsicon from "../assets/img/JS ICON.svg";
import github from "../assets/img/github-142-svgrepo-com 1.svg";
import postgresql from "../assets/img/postgresql-svgrepo-com 1.svg";
import django from "../assets/img/django-svgrepo-com 1.svg";
  ...
  return (
    <FrontendContainerStyled>
      <FrontendStyled backgrounfrontend={frontBack}>
        ...
        <FrontendH1>PYTHON-DEVELOPER</FrontendH1>
        <FrontendP>
          {language === "KG"
      ...
      <FrontendAccordionStyled>
        <div>
          ...
          <AccordionTransition arrow={pythonarrow} />
        </div>
        <FrontendSignup>

...
import img from "../assets/img/630cda98ff8816ca443cfedd_icon-basics 1.svg";
...
const frontendArrow = [
  {
    id: 1,
    title: "1.Введение в UX-дизайн",
    description: "Description for HTML-CSS.",
  },
  {
    id: 2,
    title: "2.Задачи и бизнес-цели",
    description: "Description for JavaScript.",
  },
  {
    id: 3,
    title: "3.Исследование пользователей",
    description: "Description for React JS.",
  },
  {
    id: 4,
    title: "4.Карты пути пользователей",
    description: "Description for Redux.",
  },
  {
    id: 5,
    title: "5.Сценарии взаимодействия",
    description: "Description for Redux Toolkit.",
  },
  {
    id: 6,
    title: "6.Информационная архитектура",
    description: "Description for Material-UId.",
  },
  {
    id: 7,
    title: "7.Прототипирование",
    description: "Description for Material-UI.d",
  },
  {
    id: 8,
    title: "8.Исследование юзабилити",
    description: "Description for Material-UI.s",
  },
  {
    id: 9,
    title: "9.Анализ сайта",
  ...
  return (
    <FrontendContainerStyled>
      <FrontendStyled backgrounfrontend={frontBack}>
        ...
        <FrontendH1>UX/UI-DESIGNER</FrontendH1>
        <FrontendP>
          {language === "KG"

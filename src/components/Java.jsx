...
import img from "../assets/img/java-svgrepo-com 2 (1).svg";
import hibernate from "../assets/img/hibernate-svgrepo-com 1.svg";
import springboot from "../assets/img/Group (1).svg";
  ...
  return (
    <FrontendContainerStyled>
      <FrontendStyled backgrounfrontend={frontBack}>
        ...
        <FrontendH1>JAVA-DEVELOPER</FrontendH1>
        <FrontendP>
          {language === "KG"
      ...
      <FrontendAccordionStyled>
        <div>
          ...
          <AccordionTransition arrow={javaarow} />
        </div>
        <FrontendSignup>
